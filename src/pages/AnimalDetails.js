...
const AnimalDetails = () => {
    ...
    const downloadAnimalPdf = () => {
        ...
        const diseasesLabel =
            ...
            ? animal.diseases
                .map((disease) => AnimalMaps.ANIMAL_DISEASES[Number(disease)])
                .join(", ")
            : "No known diseases";
        ...
        addLabelValue(
            "Species:",
            AnimalMaps.ANIMAL_SPECIES[animal.species ?? 99n] || "Unknown"
        );
        addLabelValue(
            "Gender:",
            AnimalMaps.ANIMAL_GENDERS[animal.gender ?? 99n] || "Unknown"
        );
        addLabelValue(
            "Fur Color:",
            AnimalMaps.ANIMAL_COLORS[animal.furColor ?? 99n] || "Unknown"
        );
        ...
        doc.text(
            "Generated by AnimalCertificate dApp",
            pageWidth / 2,
            290,
            { align: "center" }
        );
                        ...
                        <div className="flex flex-col items-center">
                            ...
                            <div className="mt-6 flex flex-wrap gap-3 justify-center">
                                ...
                                {account.address === owner && (
                                    <>
                                    {animal.dateOfDeath <= 0 &&
                                        animal.diseases.length <
                                        Object.keys(AnimalMaps.ANIMAL_DISEASES).length && (
                                        <>
                                            <AddDiseaseButton />
                                            <RemoveDiseaseButton />
                                        </>
                                        )}
                                    {animal.dateOfDeath <= 0 && <DeclareDeathButton animal={animal} />}
                                    </>
                                )}
                                </div>
                        </div>
